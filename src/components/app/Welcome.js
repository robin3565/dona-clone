...
export default function Welcome() {
    ...
    return (
        ...
        inset-0 w-screen h-full z-10 bg-gray-900/[.2]'>
            <div className='flex flex-col w-96 h-96 bg-neutral-50 rounded-lg
            justify-center p-20 drop-shadow-lg'>
                <div className='flex flex-col place-items-center'>
                    <p className='text-black text-2xl my-3'>
                        What's your name?
                    </p>
                    <input
                        className='my-3 bg-neutral-50 bg-white focus:outline-none focus:border-rose-500
